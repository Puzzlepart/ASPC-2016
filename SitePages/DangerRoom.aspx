    ...
    <div id="homeApp" ng-cloak>
        <div data-ng-controller="opsController">
            ...
            <div class="container comicblue active-operations">
                ...
                <a onClick="SP.UI.ModalDialog.showModalDialog({title: 'Add New Operation*, url: 'New-room.aspx'});">
                    <span class="material-icons">add_circle_outline</span> New Operation</a>
