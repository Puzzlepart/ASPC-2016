...
{   
    ...
    {   
        ...
        var fileCollectionEndpoint = String["format"](   
            ...
            _spPageContextInfo.webAbsoluteUrl, serverRelativeUrlToFolder, fileName, _spPageContextInfo.webAbsoluteUrl);   
    ...
    {   
        ...
        fileListItemUri = fileListItemUri.replace(_spPageContextInfo.webAbsoluteUrl, '{0}');   
    ...
    {   
        ...
        var listItemEndpoint = String["format"](listItemUri + "?@target='{0}'", _spPageContextInfo.webAbsoluteUrl);   
